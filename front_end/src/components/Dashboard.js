...
// //       <Container>
// //         <Navbar.Brand as={Link} to="/">PillsPal Medicine Reminder</Navbar.Brand>
// //         <Navbar.Toggle aria-controls="basic-navbar-nav" />
// //         <Navbar.Collapse id="basic-navbar-nav">
// //           <Nav className="ml-auto">
// //             <Nav.Link as={Link} to="/login">Login</Nav.Link>
// //             <Button variant="warning" as={Link} to="/signup" className="ml-2">Sign Up</Button>
// //           </Nav>
// //         </Navbar.Collapse>
// //       </Container>
// //     </Navbar>
...
// //             <Col md={4} className="mb-4"> {/* Add margin below each card */}
// //               <Card className="text-center h-100"> {/* Use h-100 to ensure cards are of equal height */}
// //                 <Card.Body>
...
// //                       style={{ cursor: 'pointer', width: '120px', height: '120px' }} // Increased image size
// //                     />
// //                   </Link>
// //                 </Card.Body>
// //               </Card>
...
// //       {/* Footer Section */}
// //       <footer className="text-white text-center py-3" style={{ backgroundColor: '#556b2f' }}> {/* Olive Green Background */}
// //         <Container>
...
//   return (
//     <>
//       <Navbar expand="lg" style={{ backgroundColor: '#556b2f', width: '100vw' }}> {/* Olive Green Background */}
//         <Container fluid className="d-flex justify-content-between align-items-center w-100">
//           <div className="flex-grow-1"></div>
//           <Navbar.Brand as={Link} to="/" style={{ color: '#fff', fontWeight: 'bold', textAlign: 'center' }}>
//             PillsPall Medicine Reminder
//           </Navbar.Brand>
